...
namespace ChessGameApp.LogicOfMovements
{
    public class SearchMovement
    {
        ...
        public SearchMovement()
        {
            ...
            Movement.Add(new QueenMovement()); // 5 -> queen movement
        ...
        private void CheckWhiteFigures(BasicFigure actualClickFigure, List<Player> listOfPlayers, bool isMoveWhite)
        {
            ...
            switch (actualClickFigure.Name)
            {
                ...
                case "FIRST_WHITE_KNIGHT":
                    Movement.ElementAt(2).MoveFigure(actualClickFigure, listOfPlayers, ChessBoard, isMoveWhite);
                    break;
                ...
                case "WHITE_QUEEN":
                    Movement.ElementAt(5).MoveFigure(actualClickFigure, listOfPlayers, ChessBoard, isMoveWhite);
                    break;
